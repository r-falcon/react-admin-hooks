          ...
          <Tabs>
            <TabPane tab="忘记密码" key="1">
              <Form
                ...
                labelAlign="left"
                onFinish={this.editPass}
              >
                <Form.Item
                  name="oldPass"
                  label="旧密码"
                  rules={this.state.IPT_RULE_OLDPASS}
                >
                  <Input.Password
                ...
                <Form.Item
                  name="newPass"
                  label="新密码"
                  rules={this.state.IPT_RULE_NEWPASS}
                >
                  <Input.Password
                    className={styles.iptWidth}
                    placeholder="请输入新密码"
            ...
            <TabPane tab="修改信息" key="2">
              ...
              >
                <Form.Item
                  name="username"
                  label="用户"
                  rules={this.state.IPT_RULE_USERNAME}
                >
                ...
                <Form.Item
                  name="email"
                  label="邮箱"
                  rules={this.state.IPT_RULE_EMAIL}
                >
                ...
                <Form.Item
                  name="mobile"
                  label="手机"
                  rules={this.state.IPT_RULE_MOBILE}
                >
